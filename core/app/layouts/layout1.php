...
if(!function_exists('load_view_assets')){
  function load_view_assets($view){
    ...
    if(in_array($view, ['newprovider','newprovider','editprovider','residente','autorizar','novedad','cliente','corizar','recibo','venta'])){
...
<head>
  ...
  <!-- jQuery jquery-2.2.4 -->
  <script type="text/javascript" defer src="<?php echo $url; ?>plugins/jQuery/jquery-2.2.4.js?v=1.0.1"></script>     
  <script type="text/javascript" defer src="<?php echo $url; ?>plugins/jQueryUI/jquery-ui.js?v=1.0.1"></script>
  <script type="text/javascript" defer src="<?php echo $url; ?>assets/js/jquery.flexslider.js?v=1.0.1"></script>
  <link rel="preconnect" href="https://cdnjs.cloudflare.com" crossorigin>
  <link rel="preconnect" href="https://adminlte.io" crossorigin>
  <!-- Switchery -->
  <script type="module" src="<?php echo $url; ?>plugins/switchery/switchery.min.js?v=1.0.1"></script>
  ...
  <body id="sidai" class="<?php if(isset($_SESSION["user_id"]) || isset($_SESSION["client_id"])){ echo "sidebar-mini skin-black sidebar-collapse fixed"; } else { echo ""; } ?>" onload="cerrar();">
    ...
    <!-- jquery-2.2.4 -->
    <script type="text/javascript" src="<?php echo $url; ?>plugins/jQuery/jquery-2.2.4.js"></script>
    <script type="text/javascript" src="<?php echo $url; ?>plugins/jQueryUI/jquery-ui.js"></script>
    <!-- AdminLTE App -->
    <script type="text/javascript" src="<?php echo $url; ?>assets/js/app.min.js?v=1.0.1"></script>
    <script type="text/javascript" src="<?php echo $url; ?>assets/js/bootstrap-select.min.js?v=1.0.1"></script>
    <!-- JS PDF -->
    <script type="text/javascript" src="<?php echo $url; ?>plugins/jspdf/jspdf.min.js?v=1.0.1"></script>
    <script type="text/javascript" src="<?php echo $url; ?>plugins/jspdf/jspdf.plugin.autotable.js?v=1.0.1"></script>
    <!-- Bootstrap 3.3.2 JS -->
    <script type="text/javascript" src="<?php echo $url; ?>plugins/bootstrap/js/bootstrap.min.js?v=1.0.1"></script>    
    <!-- SlimScroll -->
    ...
    <script type="text/javascript" src="<?php echo $url; ?>plugins/datetimepicker/js/bootstrap-datetimepicker.js?v=1.0.1" charset="UTF-8"></script>
    <script type="text/javascript" src="<?php echo $url; ?>plugins/datetimepicker/js/locales/bootstrap-datetimepicker.es.js?v=1.0.1" charset="UTF-8"></script>
    <script type="text/javascript" src="<?php echo $url; ?>plugins/datepicker/bootstrap-datepicker.js?v=1.0.1" charset="UTF-8"></script>
    <script type="text/javascript" src="<?php echo $url; ?>plugins/datepicker/locales/bootstrap-datepicker.es.js?v=1.0.1" charset="UTF-8"></script>
    <script type="text/javascript" src="<?php echo $url; ?>plugins/icheck/icheck.js?v=1.0.1"></script>
    <!-- Select2 -->
    <script type="text/javascript" src="<?php echo $url; ?>plugins/select2/js/select2.full.min.js?v=1.0.1"></script>
    <!-- Sweet Alert -->
    <script type="text/javascript" src="<?php echo $url; ?>plugins/sweetalert/sweetalert.min.js?v=1.0.1"></script>	<?php 
    ...
    <script type="text/javascript">      
        ...
        document.addEventListener('DOMContentLoaded', function(){
          <?php
          if(isset($_GET["view"])){
            if($_GET["view"]=="newprovider" || $_GET["view"]=="editprovider" || $_GET["view"]=="residente" || $_GET["view"]=="autorizar" || 
               $_GET["view"]=="cliente"){ ?>
                $(':input').inputmask();
                ...
                $(money).inputmask('9.999,99', { numericInput: true, reverse: true, radixPoint: "," });
                $(cuota).inputmask('99', { numericInput: true, reverse: true, radixPoint: "," }); 
