...
<head>
    ...
    <?php // Seleccion de los temas del Sistema
      if(!isset($_SESSION["user_id"])){
          // DashForge CSS
          echo '<link type="text/css" rel="stylesheet" href="assets/css/dashforge.css"/>';
          echo '<link type="text/css" rel="stylesheet" href="assets/css/dashforge.auth.css"/>';
      }else{
          // Theme style
    ...
    <script type="text/javascript" src="plugins/jQuery/jquery.min.js"></script> <!-- jquery-2.2.4 -->
    ...
    <!-- Switchery -->
    <script type="module" src="plugins/switchery/switchery.min.js"></script>
  ...
  <body id="sidai" class="<?php if(isset($_SESSION["user_id"]) || isset($_SESSION["client_id"])){ echo "sidebar-mini skin-black sidebar-collapse fixed"; } else { echo ""; } ?>" onload="cerrar();">
                  ...
                  if(isset($_SESSION["user_id"])): ?>                  
                      ...
                      <?php // 4 Comercial
                        if($_SESSION['depart'] == 4){ 
                          ...
                          <li><a href="correo"><i class='fa fa-envelope'></i> <span>E-Gestiones</span></a></li>                          
                      ...
                      <?php // 6 RRHH
                        if($_SESSION['depart'] == 6 && $_SESSION['idrol'] < 10): ?>
                            ...
                            <li class="treeview">
                              ...
                              <ul class="treeview-menu">
                                <li><a href="./index.php?view=rrhnom.lista"><i class="fa fa-circle-o"></i> Roles </a></li>
                      ...
                      <?php // Administrador
                        if($_SESSION["is_admin"] == 1): ?>
                          ...
                          <li><a href="./index.php?view=informes"><i class='fa fa-envelope'></i><span> Informes </span></a></li>
                          <li><a href="./index.php?view=cotizacion"><i class='fa fa-diamond'></i><span> Cotizaciones </span></a></li>
                          <li><a href="./index.php?view=estadistica"><i class='fa fa-line-chart'></i><span> Estadisticas </span></a></li>
                      ...
                      <li><a href="./agenda"><i class='fa fa-table'></i> <span>Agenda Semanal</span></a></li>
    ...
    <script type="text/javascript" src="./plugins/datetimepicker/js/locales/bootstrap-datetimepicker.es.js" charset="UTF-8"></script>
    <script type="text/javascript" src="./plugins/datepicker/bootstrap-datepicker.js" charset="UTF-8"></script>
    <script type="text/javascript" src="./plugins/datepicker/locales/bootstrap-datepicker.es.js" charset="UTF-8"></script>
	...
	<?php // Seleccion de los temas del Sistema
		if(isset($_GET["view"]) && $_GET["view"] == "calendar"){
			// Full Calendar
			echo '<script type="text/javascript" src="./plugins/fullcalendar/moment.min.js"></script>';
			echo '<link type="text/css" rel="stylesheet" href="./plugins/fullcalendar/fullcalendar.min.css">';
    	echo '<link type="text/css" rel="stylesheet" href="./plugins/fullcalendar/fullcalendar.print.css" media="print">';
			echo '<script type="text/javascript" src="./plugins/fullcalendar/fullcalendar.min.js"></script>';
			echo '<script type="text/javascript" src="./plugins/fullcalendar/locale-all.js"></script>';
    }
    ?>
    <?php
    if(isset($_GET["view"])){
			...
			if($_GET["view"]=="newprovider" || $_GET["view"]=="editprovider" || $_GET["view"]=="catres.residents" || $_GET["view"]=="autorizar" || $_GET["view"]=="novedad" || 
			   $_GET["view"]=="clientes" || $_GET["view"]=="corizar"){
				echo '<script type="text/javascript" src="plugins/input-mask/jquery.inputmask.js"></script>';
				echo '<script type="text/javascript" src="plugins/input-mask/jquery.inputmask.date.extensions.js"></script>';
				echo '<script type="text/javascript" src="plugins/input-mask/jquery.inputmask.extensions.js"></script>';
			}
			if($_GET["view"]=="sell"){
				echo '<script type="text/javascript" src="plugins/jsqrcode/llqrcode.js"></script>';
				echo '<script type="text/javascript" src="plugins/jsqrcode/webqr.js"></script>';
			}
