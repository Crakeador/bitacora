...
if(isset($_POST['id_person'])){
    ...
    if($errores == ''){
        Core::alert("Exito...!!!!", "Se guardo su registro", "error", "home");
    }else{
...
<section class="content-header">
	<h1>
		Residentes
		<small>reporte de da&ntilde;os</small>
	</h1>
	<ol class="breadcrumb">
...
<section id="main" role="main">
    <div class="container-fluid">
        <form class="form-horizontal" method="post" enctype="multipart/form-data" id="parte" name="parte" action="informo" role="form">
                ...
                <div class="col-md-7">
                    <div class="panel panel-default">
                        ...
                        <div class="panel-heading">
                            <h3 class="panel-title"><i class="mr5"></i>Reporte de novedades</h3>
                        </div>
                        <!--/ panel heading/header -->
                                ...
                                <div class="" id="fisicos">                                    
                    				<div class="form-group">
                    					...
                    					<div class="col-md-8 col-sm-6">
                    						<input class="text-field form-control input-sm" id="descripcion" name="descripcion" value="<?php echo $_SESSION["clientes"]; ?>" readonly="readonly">
                    					</div>
                    				</div>
                                    <div class="form-group">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-8">
                                            <textarea class="form-control" id="observacion" name="observacion" placeholder="Reporte la novedad que observa en el sitio" cols="40" rows="5"><?php echo $Observacion; ?></textarea>
                                        </div>
                                    </div>
                                    <div class="form-group">
