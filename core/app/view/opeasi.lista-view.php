...
<section class="content" style="padding: 1.5rem !important;">
  <div class="box box-primary">
    <div class="box-header with-border">
		...
		<label>
			<?php
				echo '<select id="localidad_id" name="localidad_id" class="form-control" onchange="javascript:location.href=\'index.php?view=opeasi.lista&id=\'+value;">';
		...
		<a href="index.php?view=opeasi.personal" class="btn btn-success btn-sm">
									  ...
									  echo '<tr>'; 
										if($users[$i]->descripcion == ''){
										  ...
										  echo '<td>';
											...
											echo '</br>';
											echo '<small>';
											  echo '<a href="index.php?view=opeasi.personal&id='.$users[$i]->servicio.'" class="btn btn-xs btn-success"><i class="glyphicon glyphicon-edit"></i></a>&nbsp;';
											  echo '<a href="index.php?view=opeasi.lista&status='.$users[$i]->servicio.'" class="btn btn-xs btn-danger"><i class="glyphicon glyphicon-remove"></i></a>&nbsp;';
											  echo $users[$i]->lugar;
											echo '</small>';
										  echo '</td>';
										}
									  ...
									  echo '<tr>'; 
										if($userf[$i]->descripcion == ''){
										  ...
										  echo '<td>';
											...
											echo '</br>';
											echo '<small>';
											  echo '<a href="index.php?view=opeasi.personal&id='.$userf[$i]->servicio.'" class="btn btn-xs btn-success"><i class="glyphicon glyphicon-edit"></i></a>&nbsp;';
											  echo '<a href="index.php?view=opeasi.lista&status='.$userf[$i]->servicio.'" class="btn btn-xs btn-danger"><i class="glyphicon glyphicon-remove"></i></a>&nbsp;';
											  echo $userf[$i]->lugar;
											echo '</small>';
										  echo '</td>';
										}
