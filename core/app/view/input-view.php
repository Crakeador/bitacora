...
<div class="row">
  ...
  <div style="font-size:34px;">Alta en inventario</div>
		...
		<br>
		<form class="form-horizontal" method="post" action="index.php?view=processinput" role="form">
		   <div class="form-group">
		    <label for="inputUnidad" class="col-lg-2 control-label">Unidad</label>
		    <div class="col-lg-10">
		      <input type="text" value="<?php echo $product->unit; ?>" readonly="readonly" class="form-control" id="inputUnidad" placeholder="Cantidad de productos">
		    </div>
		  </div>
		  <div class="form-group">
		    <label for="inputCantidad" class="col-lg-2 control-label">Cantidad</label>
		    <div class="col-lg-10">
		      <input type="float" required name="q" class="form-control" id="q" placeholder="Cantidad de productos">
		    </div>
		  </div>
		  <div class="form-group">
