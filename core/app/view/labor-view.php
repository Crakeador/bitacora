...
if(count($_POST)>0){
	...
	$sumas = TimelineData::updateVista($_GET['id'], $vistas);
}
//http://localhost/bitacora/labor
?>
...
<section id="main" role="main">
	<div class="container-fluid">
		<div class="row">
			...
			<div class="col-md-12">
				<!-- START panel -->
				<form class="form-horizontal" method="post" id="addtask" action="index.php?view=labor" role="form">
					...
					<div class="panel panel-default">
						...
						<div class="panel-body">
    			            <button type="submit" class="btn btn-success pull-right"><span class="glyphicon glyphicon-floppy-disk"></span> Actualizar Tarea </button>
							...
							<div class="form-group">
								<label for="company_id" class="col-md-2 col-sm-3 control-label">Empresa:</label>
							...
							<div class="form-group">
								<label class="col-md-2 col-sm-3 control-label"> Ejecutor:</label>
								<div class="col-md-3 col-sm-4">
									<select class="select-input form-control input-sm" id="persona_id" name="persona">
										<option value="0" selected="selected"> Selecione... </option>
										<?php
											foreach($users as $user):?>
												<option value="<?php echo $user->id; ?>" <?php if($user->id == $datos->idperson) echo 'selected="selected"'; ?>><?php echo $user->name.' '.$user->lastname;?></option>
											<?php endforeach;
										?>
									</select>
								</div>
        					...
        					<div class="form-group">
        						...
        						<div class="col-md-4">
        							<select class="select-input form-control" id="id_active" name="id_active">
        								...
        								<option value="7"> Cumplio con retraso </option>
        							</select>
        						</div>
        					</div>
						</div>
