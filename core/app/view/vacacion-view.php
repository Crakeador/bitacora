...
if(isset($_GET["id"])){
	...
	if(count($_POST)>0){
		...
		$registro->idperson = $_POST["idperson"];
...
<section class="content-header">
	...
	<ol class="breadcrumb">
		<li><a href="vacaciones"><i class="fa fa-calendar"></i> Lista de vacaciones </a></li>
...
<section id="main" role="main" style="padding: 1.5rem !important;">
	<div class="container-fluid">
		<div class="row">
			...
			<form class="form-horizontal" method="post" id="datos_vacaciones" action="vacacion" role="form">
