<?php
$product = PuestoData::getByIdProduct($_GET["id"]);
...
if($product!=null){
		echo '<div class="row">';
		  ...
		  if(isset($_SESSION["update"]) && $_SESSION["update"] == 1){
			...
			echo '<br>';
			echo '<form class="form-horizontal" method="post" id="updateserial" enctype="multipart/form-data" action="index.php?view=updateserial" role="form">';
			  echo '<div class="form-group">';
					echo '<input type="hidden" name="puesto_id" value="'.$product->id.'">';
		  	...
		  	echo '</div>';
		  	echo '<div class="form-group">';
		    	echo '<label for="inputResponsable" class="col-lg-3 control-label">Responsable:</label>';
		    	echo '<div class="col-md-8">';
		      	echo '<input type="text" name="name" class="form-control" id="name" value="'.$product->name.'" placeholder="Reponsable que recibe los equipos">';
		    	echo '</div>';
		  	echo '</div>';
				echo '<div class="form-group">';
		    ...
		    echo '<div class="form-group">';
		    	...
		    	echo '<div class="col-md-8">';
			    	echo '<select name="estado" class="form-control">';
			    		echo '<option value="">-- NINGUNA --'.$product->estado.'</option>';
