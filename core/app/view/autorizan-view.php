<?php 
//Listado de las visitas autorizadas por el residente
$validos = AutorizanData::getAll(1);
...
<section class="content" style="padding: 1.5rem !important;">
	<div class="box">
		<div class="box-header with-border">
			<a id="btn_productos" class="btn btn-success btn-sm" href="index.php?view=autorizar">
		...
		<div class="box-body mailbox-messages">
			<form id='frmC' name='frmC' method='post' action=''>
				...
				<table id="viewlista" class="table table-bordered table-hover">
					...
					<tbody>
						<?php
							$permiso = AutorizanData::getAll(1);
