                                ...
                                <div id="datos_laborales">
                                    <div class="panel panel-default">
                                        ...
                                        <div class="panel-collapse pull out">
                                            <div class="panel-body">
                                                <div class="form-group">
                                                    <label class="col-md-4 col-sm-4 control-label"> Fecha de :</label>
                                                    <div class="col-md-6 col-sm-6">
                                                        <input type="date" class="form-control" id="startwork" name="startwork" value="<?php echo $person->startwork; ?>" minlength="10" title="Debe de ser una fecha valida">
                                                    </div>
                                                </div>
                                                <div class="form-group">
