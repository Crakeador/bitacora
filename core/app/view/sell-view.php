...
<section class="content">
	<div class="row">
		<div class="col-md-10 col-sm-10">
			<h1>Asignaci&oacute;n de Materiales</h1>
			...
			<div class="col-md-12">
				...
				<form method="post" class="form-horizontal" id="processsell" action="index.php?view=processsell">
					...
					<div class="form-group">
						<label for="inputCliente" class="col-lg-2 control-label">Cliente</label>
						<div class="col-lg-10">
							<?php
									$clients = PersonData::getClients();

									echo '<select name="client_id" class="form-control">';
										echo '<option value="">-- NINGUNO --</option>';
									foreach($clients as $client){
										echo '<option value="'.$client->id.'">'.utf8_encode($client->name).'</option>';
									}
									echo '</select>';
								?>
						</div>
					...
					<div class="form-group">
					<label for="inputDiscount" class="col-lg-2 control-label">Descuento</label>
					<div class="col-lg-10">
					...
					<div class="form-group">
						...
						<div class="checkbox">
							<label>
								...
								<button class="btn btn-lg btn-primary"> Asignar Equipo </button>
							</label>
						</div>
						</div>
					</div>
