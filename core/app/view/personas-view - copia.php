...
$puestos = GruposData::getAll(); $lugar = '';
...
if(isset($_GET['id'])){
	...
	if($lugar == 99){
		$users = GruposData::getAsignar();
	}else{
		$users = GruposData::getAllGrupo($lugar, 1);			
	}
	
	$userf = GruposData::getAllGrupo($lugar, 0);
	$activo = count($users);
	$activa = count($userf);
}else{
...
<section class="content" style="padding: 1.5rem !important;">
  <div class="box box-primary">
    <div class="box-header">
		...
		<label>
			<?php
				echo '<select id="localidad_id" name="localidad_id" class="form-control" onchange="javascript:location.href=\''.$_SESSION["url"].'grupos/\'+value;">';
