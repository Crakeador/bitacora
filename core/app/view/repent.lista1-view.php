					...
					<div class="box-body mailbox-messages">
						<table id="viewlista" class="table table-bordered table-hover">
							...
							<?php
								...
								// Crea tabla de Entrega de dotacion
								foreach($products as $sell) {
									echo '<tr>';
										echo '<td width="30%">'.utf8_encode($sell->name).'</td>';
										$operations = PuestoData::getByIdPuesto($sell->person_id);
										...
										echo '<td style="width:30px;"><a href="index.php?view=repent.detalle&id='.$sell->person_id.'" class="btn btn-xs btn-default"><i class="glyphicon glyphicon-eye-open"></i></a></td>';
									echo '</tr>';
								}
							?>
							</tbody>
