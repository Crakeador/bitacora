...
<section class="content" style="padding: 1.5rem !important;">
	<div class="box">
		<div class="box-header with-border">
			<a id="btn_productos" class="btn btn-success btn-sm" href="index.php?view=catpus.puesto">
								...
								foreach($puestos as $sell) {
									...
									echo '<tr>';
										...
										echo '<td><div align="center">';
										    echo '<button type="button" class="btn btn-xs btn-default" onClick="btn_EnviarOnClick(\''.$sell->id.'\');"><i class="fa fa-qrcode"></i></button>';
										    echo '<a href="index.php?view=resumenpuesto&id='.$sell->id.'" class="btn btn-xs btn-warning"><i class="glyphicon glyphicon-eye-open"></i></a>';
										    echo '<a href="index.php?view=catpus.puesto&id='.$sell->id.'" class="btn btn-xs btn-success"><i class="glyphicon glyphicon-edit"></i></a></div>';
										echo '</td>';
									echo '</tr>';
								}
							?>
						...
						<?php
							...
							foreach($puestos as $sell) {
								...
								echo '<tr>';
									...
									echo '<td>'.$sell->horas.' '.$sell->horario.'</td>';
									echo '<td>';
									   echo '<a href="index.php?view=resumenpuesto&id='.$sell->id.'" class="btn btn-xs btn-danger"><i class="glyphicon glyphicon-eye-open"></i></a>';
									   echo '<a href="index.php?view=catpus.puesto&id='.$sell->id.'" class="btn btn-xs btn-success"><i class="glyphicon glyphicon-edit"></i></a>';
									echo '</td>';
								echo '</tr>';
							}
						?>
...
<script type='text/javascript'><!--
	...
	function btn_EnviarOnClick($id) {		
		window.location.href = "./index.php?view=catpus.lista&id="+$id;
	} //--
</script>