...
<script type="text/javascript" src="https://maps.googleapis.com/maps/api/js?key=AIzaSyAnge7sTWX0Bg9KprAw2W2bsUPcT4QwM3U"></script>
<script>
var vMarker
var map
    ...
    vMarker = new google.maps.Marker({
        position: new google.maps.LatLng(<?php echo $lat; ?>, <?php echo $lot; ?>),
        draggable: true
    });
