<div class="row">
	...
	<section class="content-header">
		<h1>
			...
			<small>Roles de usuarios</small>
		</h1>
		<ol class="breadcrumb">
			<li><a href="./index.php?view=home"><i class="fa fa-book"></i> Mantenimiento </a></li>
			<li class="active">Roles de usuarios</li>
		</ol>
	</section>
	<!-- Main content -->
						...
						<div class="box">
							<div class="box-body mailbox-messages">
								<table id="viewlista" class="table table-bordered table-hover">
									...
									<tbody>
									<?php
										$rols = RolesData::getAll();

										// Crea tabla de Ventas
										foreach($rols as $tables) {
											echo '<tr>';
  											echo '<td>'.$tables->name.'</td>';
	  										echo '<td>'.$tables->alias.'</td>';
												...
												echo '<td width="10%">';
													echo '<div align="center">';
														echo '<button type="button" class="btn btn-default btn-sm" onClick="btn_EnviarOnClick(\''.$tables->id.'\', \''.$tables->active.'\');"><i class="fa fa-trash"></i></button>';
...
<script type='text/javascript'><!--
	...
	function btn_UpdateOnClick($id) {
		window.location.href = "./?view=editdepartamento&id="+$id;
	} //

	function btn_NuevoOnClick() {
		window.location.href = "./?view=newdepartamento";
	} //
</script>
