...
<section class="content-header">
  <h1>
    ...
    <small>lista de mensajes enviados</small>
  </h1>
  <ol class="breadcrumb">
...
<section class="content">
  <div class="row">
    <div class="col-md-3">
      <a href="./index.php?view=compose" class="btn btn-danger btn-block margin-bottom">Cralizar Solicitud</a>
      ...
      <div class="box box-solid">
        ...
        <div class="box-body no-padding">
          <ul class="nav nav-pills nav-stacked">
            ...
            <li><a href="#"><i class="fa fa-circle-o text-yellow"></i> Advertencia</a></li>
            <li><a href="#"><i class="fa fa-circle-o text-light-blue"></i> Informativo</a></li>
          </ul>
        </div>
        <!-- /.box-body -->
      </div>
      ...
      <div class="box box-danger">
        ...
        <div class="box-body no-padding">
          <div class="mailbox-controls">
            ...
            <!-- /.btn-group -->
            <button type="button" class="btn btn-default btn-sm"><i class="fa fa-sync"></i></button>
