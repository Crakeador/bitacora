...
<section class="content-header">
	<h1>
		Administrativo
		<small>resumen de la asistencia del personal administrativo</small>
	</h1>
	<ol class="breadcrumb">
		<li><a href="#"><i class="fa fa-book"></i> Administrativo </a></li>
		<li class="active"> Resumen de asistencia </li>
	</ol>
</section>
			...
			<div class="box-body mailbox-messages">
					...
					<div class="col-sm-6">
						<div class="dataTables_length" id="example_length">
							<label>Ver el reporte de asistencia de:&nbsp;
								<select style="width: 120px; display: inline-block;" id="mes_id" name="mes_id" class="form-control" onchange="javascript:location.href='?view=resumenadm&mes='+value;">
						...
						<div id="example_filter" class="dataTables_filter">
							...
							<label>
								<?php
									...
									echo '<select id="localidad_id" name="localidad_id" class="form-control" onchange="javascript:location.href=\'?view=rrphor.resumen&id=\'+value;">';
				...
				<div style="height: 510px; width: 100%; overflow-x: auto;" id="example_length">
					<table id="horario" class="table table-bordered table-hover">
						<thead>
							<tr>
								<th><div align="center">Agentes</div></th>
								...
								<th style="width:14%"><div align="center">Fin del Contrato</div></th>
							</tr>
						</thead>
						<tbody>
							<?php
																	...
																	if($valor[$i-1]['turno']==7) {// turno doble dia
																		...
																		if($valor[$i-1]['turno']==8) {// turno doble dia
																			...
																			if($valor[$i-1]['turno']==9) {// turno dia moto
																				...
																				if($valor[$i-1]['turno']==10) {// Renuncia
																					$renuncio = $ano.'-'.$mes.'-'.$i;
																				}
																			}
																		}
