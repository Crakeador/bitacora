...
if(isset($_GET['id'])){
    ...
    if(count($_POST)>0){
        ...
        if($errores == ''){
            ...
            $user->is_empleado = $_POST["is_empleado"];
                                            ...
                                            <div class="" id="datos">
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <div class="col-sm-6">
                                                        ...
                                                        <div class="radiobutton">
                                                            <input type="radio" id="is_empleado" name="is_empleado" value="1" <?php if($person->is_empleado==1) echo 'checked'; ?>> Si &nbsp;&nbsp;
                                                            <input type="radio" id="is_empleado" name="is_empleado" value="0" <?php if($person->is_empleado==0) echo 'checked'; ?>> No&nbsp;&nbsp;
                                                            <input type="radio" id="is_empleado" name="is_empleado" value="2" <?php if($person->is_empleado==0) echo 'checked'; ?>> Eventual
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
