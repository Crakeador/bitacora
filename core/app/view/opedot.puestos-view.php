	...
	<div class="row">
		...
		<div class="col-lg-5">
			<div class="box box-success">
				<form role="form" method="post" class="form-horizontal" id="processsell" action="index.php?view=processsell&valor=1">
						...
						<div class="col-md-12">
							<div class="form-group">
								...
								<span class="input-group-addon"><i class="fa fa-university"></i></span>
									<select class="form-control" id="listaCliente" name="listaCliente" onchange="javascript:location.href='index.php?view=opedot.puestos&id='+value;" required>
							...
							<div class="form-group">
								<div class="input-group">
									...
									<select class="form-control" id="listaPuesto" name="listaPuesto" onchange="javascript:location.href='index.php?view=opedot.puestos&puesto='+value;" required>
										...
										<?php
											if(isset($puestos)){
												foreach($puestos as $puesto){
													...
													echo '<option value="'.$puesto->id.'" '.$valor.'>'.$puesto->descripcion.'</option>'; //utf8_encode()
												}
											}
										?>
									</select>
							...
							<div class="form-group">
								<div class="input-group">
									...
									<select class="form-control" id="client_id" name="client_id" onchange="javascript:location.href='index.php?view=opedot.puestos&person='+value;" required>
								...
								foreach($products as $tables) {									
									...
									if($q>0){
										echo '<tr>';
											...
											echo '<td>';
												echo '<form method="post" action="index.php?view=addtocart&valor=2">';
