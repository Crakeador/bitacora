...
$today = getdate(); $hora=$today["hours"]; $estilo = ''; $mensaje  = '';
...
<section id="main" role="main">
  <div class="container-fluid">
    <form class="form-horizontal" method="post" enctype="multipart/form-data" id="bitacora" name="asignar" action="index.php?view=salir" role="form">
                ...
                <div class="panel panel-default">
                    ...
                    <div class="panel-collapse pull out">
                        <div class="panel-body">
                            ...
                            <div class="form-group">
                                <label for="fecha" class="col-md-4 col-sm-4 control-label"><span class="text-danger">*</span> Fecha:</label>
								<div class="col-md-6 col-sm-6">
					                <div class="input-group date form_datetime col-md-9 col-sm-6">
						                <input id="fecha" class="form-control" size="10" type="text" value="<?php echo $hoy; ?>" readonly>
							...
							<div class="form-group">
                                ...
                                <div class="col-xs-10">								
                                    ...
                                    <span class="text-danger">Pasar la consigna</span>
                                </div>
                            </div>
							<div class="form-group">
...
<script>
    ...
    if(localStorage.getItem("usuario") != null){
        ...
        alert("Se va ha cerrar turno abierto...!!!");
    }else{
