		...
		<div class="box-header with-border"> 
			<div class="col-md-6 col-sm-10">
				<div class="dataTables_length" id="example_length">
					<label>Asistencia de:&nbsp;
						<select style="width: 120px; display: inline-block;" id="mes_id" name="mes_id" class="form-control" onchange="javascript:location.href='index.php?action=horario&tipo=3&mes='+value;">
			...
			<div class="col-md-6 col-sm-10">					
				<div id="example_filter">
					...
					<label>
						<?php
							echo '<select id="localidad_id" name="localidad_id" class="form-control" onchange="javascript:location.href=\'index.php?action=horario&tipo=3&id=\'+value;">';
				...
				<div class="col-sm-12">
					<div class="alert alert-dismissable alert-info">
						...
						<p> - Los turnos se identifican con los siguientes colores:&nbsp;</br>
							<span class="label label-success">M</span>&nbsp;Ma&ntilde;ana,&nbsp;
							<span class="label label-primary">T</span>&nbsp;Tarde,&nbsp;
							<span class="label label-warning">L</span>&nbsp;Libre,&nbsp;
							<span class="label label-danger" >F</span>&nbsp;Falta,&nbsp;
							<span class="label label-purple" >N</span>&nbsp;Noche
						</p>
					</div>
				</div>
			</div>
...
<script>
	...
	function btn_NuevoOnClick(id, dia, mes, ano, agente, servicio, boton, hiden) {
		...
		//Agregamos la imagen de carga en el contenedor 
		$.ajax({
			type: "POST",
