...
<section class="content-header">
	...
	<ol class="breadcrumb">
		<li><a href="./index.php?view=catcar.lista"><i class="fa fa-database"></i> Cargos </a></li>
...
<section id="main" role="main" style="padding: 1.5rem !important;">
	...
	<!-- START panel -->
	<form class="form-horizontal" method="post" id="addproduct" action="index.php?view=catcar.cargo" role="form">
