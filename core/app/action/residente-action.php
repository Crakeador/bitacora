                        ...
                        <div class="card-body">
                            <form class="form-horizontal" method="post" id="cotizacion" action="index.php?action=solicitud" role="form">
                                <fieldset class="form-fieldset">
                                    ...
                                    <div class="form-group">
                                        <p>
                                            <fieldset>
                                                ...
                                                <input type="radio" required name="tipo" id="tipo" value="1">&nbsp;&nbsp;<label for="r1">Residente</label>
                                                <input type="radio" required name="tipo" id="tipo" value="2">&nbsp;&nbsp;<label for="r2">Inquilino</label>
                                            </fieldset>
                                        </p>
                                    </div>
                                    <div class="form-group">
                                        <label for="telefono1" class="d-block">Celular:</label>
                                        <input type="number" id="telefono1" name="telefono1" class="form-control" placeholder="Numero de celular" value="" required>
                                    </div>
                                    <div class="form-group">
                                        <label for="telefono2" class="d-block">Convencional:</label>
                                        <input type="number" id="telefono2" name="telefono2" class="form-control" placeholder="Numero de celular" value="" required>
                                    </div>
                                    <div class="form-group">
                                        <label for="manzana" class="d-block">Manzana:</label>
                                        <input type="number" id="manzana" name="manzana" class="form-control" placeholder="Numero de la manzana" value="" required>
                                    </div>
                                    <div class="form-group">
                                        <label for="villa" class="d-block">Villa:</label>
                                        <input type="number" id="villa" name="villa" class="form-control" placeholder="Numero de la villa" value="" required>
                                    </div>
                                    <div class="form-group">
                                    ...
                                    <div class="form-group">
                                        <label for="observacion" class="d-block">Observacion:</label>
