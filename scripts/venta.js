...
function buscarDetalle(idarticulo,articulo,precio_venta){
	var cantidad=1;	
	var serial=$("#seriales option:selected").text();
	var descuento=$("#seriales option:selected").val();
	...
	if (idarticulo!="") {
		...
		var fila='<tr class="filas" id="fila'+cont+'">'+
			...
			'<td width="8%"><input type="number" name="precio_venta[]" id="precio_venta[]" value="'+precio_venta+'"></td>'+
			'<td width="8%"><input type="number" name="descuento[]" value="'+serial+'"></td>'+
			'<td width="8%"><span id="subtotal'+cont+'" name="subtotal">'+subtotal+'</span></td>'+
		'</tr>';
		cont++;
		detalles++;
...
function agregarDetalle(idarticulo,articulo,precio_venta){
	...
	if (idarticulo!="") {
		...
		var fila='<tr class="filas" id="fila'+cont+'">'+
			...
			'<td width="8%"><input type="number" name="cantidad[]" id="cantidad[]" value="'+cantidad+'"></td>'+
			'<td width="8%"><input type="number" name="precio_venta[]" id="precio_venta[]" value="'+precio_venta+'"></td>'+
			'<td width="8%"><input type="number" name="descuento[]" value="'+descuento+'"></td>'+
			'<td width="8%"><span id="subtotal'+cont+'" name="subtotal">'+subtotal+'</span></td>'+
		'</tr>';
		cont++;
		detalles++;
