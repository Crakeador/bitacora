<?php
// Clase de Horarios 
class DespliegueData {
	public static $tablename = "despliegue"; 
	...
	public static function getByTurnos($servicio, $id, $dia, $mes, $ano, $tipo){
		$sql = "select * from ".self::$tablename." where idservicio=$servicio and idagente=$id and CAST(dia AS UNSIGNED)=$dia and CAST(mes AS UNSIGNED)=$mes and CAST(ano AS UNSIGNED)=$ano and tipo=$tipo"; 
		$query = Executor::doit($sql);

		return Model::many($query[0],new DespliegueData());
	}
