...
$sql = "SELECT A.*, B.name, B.lastname FROM respuesta A, user B WHERE B.id = A.iduser AND A.idtimeline = $id";
error_log("DEBUG getRespuesta.php - SQL: " . $sql); // Log para debugging
$sub = $con->query($sql);
